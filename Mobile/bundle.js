...
var clientsArr = [{ id: 101, fam: "Иванов", im: "Иван", otch: "Иванович", balance: 200 }, { id: 105, fam: "Сидоров", im: "Сидор", otch: "Сидорович", balance: 250 }, { id: 110, fam: "Петров", im: "Пётр", otch: "Петрович", balance: 1 }, { id: 120, fam: "Григорьев", im: "Григорий", otch: "Григорьевич", balance: 220 }];
...
var MobileCompany = function (_React$PureComponent) {
  ...
  function MobileCompany() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MobileCompany.__proto__ || Object.getPrototypeOf(MobileCompany)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      clients: _this.props.clients.map(function (v) {
        v.edited = false;
        return v;
      }),
      notFilteredClients: _this.props.clients.map(function (v) {
        v.edited = false;
        return v;
      })
    }, _this.setName = function (EO) {
      ...
      var newClient = void 0;
      var newFilteredClients = [].concat(_toConsumableArray(_this.state.notFilteredClients));

      newClients.forEach(function (c, i) {
        if (c.id == clientId) {
          newClient = _extends({}, c); // копия хэша изменившегося клиента
      ...
      if (changed) {
        newFilteredClients.forEach(function (c, i) {
          if (c.id == clientId) {
    ...
    }, _this.setClientFIO = function (clientId, newFIO) {
      var changed = false;
      var newClients = [].concat(_toConsumableArray(_this.state.clients)); // копия самого массива клиентов
      var newClient = void 0;
      var newFilteredClients = [].concat(_toConsumableArray(_this.state.notFilteredClients));
      ...
      var currentClients = _this.state.clients;
      var newClientId = currentClients[currentClients.length - 1].id + 1;
      ...
      var newClient = {
        ...
        im: "",
        otch: "",
        balance: _this.state.filter == "blocked" ? -1 : 0,
        edited: true
      };
      ...
      var newClients = [].concat(_toConsumableArray(_this.state.cliens));
      var newFilteredClients = [].concat(_toConsumableArray(_this.state.notFilteredClients));
      newClients.forEach(function (c, i) {
        if (c.id == clientId) {
    ...
    }, _this.clientFilter = function (EO) {
      var newFilter = EO.target.value;
      if (newFilter !== _this.state.filter) {
        var clients = _this.state.clients;
        var filteredClients = [];

        if (newFilter == "all") {
          filteredClients = [].concat(_toConsumableArray(clients));
        ...
        console.log(_this.state.notFilteredClients);
      }
  ...
  _createClass(MobileCompany, [{
    ...
    value: function render() {
      ...
      var clients = this.state.notFilteredClients.map(function (client) {

        return _react2.default.createElement(_MobileClient2.default, {
          key: client.id,
          client: client,
          onFIOChange: _this2.setClientFIO,
          onBalanceChange: _this2.setBalance,
          onDelete: _this2.deleteClient
        });
      });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'MobileCompanyTitle' },
          _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement('input', { type: 'button', value: 'Velcom', onClick: this.setName }),
            _react2.default.createElement('input', { type: 'button', value: 'MTC', onClick: this.setName })
          ),
          _react2.default.createElement(
            'div',
            { className: '' },
            ...
            _react2.default.createElement(
              'select',
              { id: 'filter', value: this.state.filter, onChange: this.clientFilter },
              _react2.default.createElement(
                'option',
                { value: 'all' },
                'All'
        ...
        _react2.default.createElement(
          'button',
          { className: 'MobileNewClientButton', onClick: this.addClient },
          'Add new client'
        )
      );
    }
...
var MobileClient = function (_React$PureComponent) {
  ...
  function MobileClient() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MobileClient.__proto__ || Object.getPrototypeOf(MobileClient)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      fam: _this.props.client.fam,
      im: _this.props.client.im,
      otch: _this.props.client.otch,

      balance: _this.props.client.balance,
      edited: _this.props.client.edited,
      active: _this.props.client.balance >= 0
    }, _this.componentWillReceiveProps = function (newProps) {
      //console.log("MobileClient id="+this.props.id+" componentWillReceiveProps");
      var fam = _this.state.fam;
      var im = _this.state.im;
      var otch = _this.state.otch;
      var newClient = newProps.client;
      if (_this.fam != newClient.fam || im != newClient.im || otch != newClient.otch) {
        _this.setState({
      ...
      if (_this.state.balance != newClient.balance) {
        _this.setState({
          balance: newProps.client.balance,
          active: newProps.client.balance >= 0
        });
      }
      if (_this.state.edited != newClient.edited) {
        _this.setState({
          edited: newClient.edited
        });
      }
    }, _this.editButton = function () {
      _this.setState({ edited: true });
    }, _this.increaseBalance = function () {
      _this.props.onBalanceChange(_this.props.client.id, ++_this.state.balance);
      if (_this.state.balance >= 0) {
        _this.setState({
          active: true
        });
        // console.log(this.state.balance)
      }
    }, _this.decreaseBalance = function () {
      _this.props.onBalanceChange(_this.props.client.id, --_this.state.balance);
      if (_this.state.balance < 0) {
        _this.setState({
          active: false
      ...
      _this.props.onDelete(_this.props.client.id);
    }, _this.saveForm = function (EO) {
      EO.preventDefault();
      ...
      _this.props.onFIOChange(_this.props.client.id, FIO);
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.state.edited ? _react2.default.createElement(
              'form',
              { onSubmit: this.saveForm, className: 'MobileClientFioForm' },
              _react2.default.createElement('input', { type: 'text', defaultValue: this.state.fam, name: 'fam' }),
              _react2.default.createElement('input', { type: 'text', defaultValue: this.state.im, name: 'im' }),
              _react2.default.createElement('input', { type: 'text', defaultValue: this.state.otch, name: 'otch' }),
              _react2.default.createElement('input', { type: 'submit', value: 'Save' })
            ) : _react2.default.createElement(
              'div',
              { className: 'MobileClientFioContainer' },
              _react2.default.createElement(
                'span',
                null,
                this.state.fam + " " + this.state.im + " " + this.state.otch
              ),
              _react2.default.createElement(
                'button',
          ...
          _react2.default.createElement(
            'div',
            { className: 'MobileClientActive' },
            this.state.active ? _react2.default.createElement(
              'span',
              { className: 'MobileClientActiveActive' },
              'Active'
            ) : _react2.default.createElement(
              'span',
              { className: 'MobileClientActiveBlocked' },
              'Blocked'
            )
          ),
          _react2.default.createElement(
            'div',
            { className: 'MobileClientDelete' },
            _react2.default.createElement(
              'button',
...
MobileClient.propTypes = {
  ...
  onFIOChange: _propTypes2.default.func.isRequired,
  onBalanceChange: _propTypes2.default.func.isRequired,
