...
var Br2jsx = function (_React$Component) {
  ...
  function Br2jsx(props) {
    ...
    var _this = _possibleConstructorReturn(this, (Br2jsx.__proto__ || Object.getPrototypeOf(Br2jsx)).call(this, props));

    _this.brReplacer = function (text) {
      text = text.split(/<br>|<br\/\>|<br \/\>/);
      return text.map(function (part, i) {
        return _react2.default.createElement(
          'p',
          { className: 'part', key: i },
          part
        );
      });
    };
    ...
    _this.state = {
      text: _this.brReplacer(props.text)
    };
    return _this;
  }
...
module.exports = "Lorem ipsum dolor <br> sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt <br/>ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat <br />nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."
