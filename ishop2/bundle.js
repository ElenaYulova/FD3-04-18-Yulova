...
var _GoodsTable = __webpack_require__(22);

var _GoodsTable2 = _interopRequireDefault(_GoodsTable);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var goodsArr = __webpack_require__(26);

_reactDom2.default.render(_react2.default.createElement(_GoodsTable2.default, { goods: goodsArr }), document.getElementById('container'));
...
var _ItemGoods = __webpack_require__(23);

var _ItemGoods2 = _interopRequireDefault(_ItemGoods);
...
var GoodsTable = function (_React$Component) {
    _inherits(GoodsTable, _React$Component);

    function GoodsTable(props) {
        _classCallCheck(this, GoodsTable);

        var _this = _possibleConstructorReturn(this, (GoodsTable.__proto__ || Object.getPrototypeOf(GoodsTable)).call(this, props));

        _this.cbitemDelete = function (code) {
            _this.setState({ goods: _this.state.goods.filter(function (good) {
                    return good.code != code;
                }) });
        };

        _this.cbitemClicked = function (code) {
            _this.setState({ selected: code });
        };
        ...
        _this.cbitemClicked = _this.cbitemClicked.bind(_this);
        _this.cbitemDelete = _this.cbitemDelete.bind(_this);
        return _this;
    }

    _createClass(GoodsTable, [{
        key: 'render',
        value: function render() {
            var _this2 = this;

            var goodsList = this.state.goods.map(function (item) {
                return _react2.default.createElement(_ItemGoods2.default, {
                    name: name,
                    key: item.code,
                    code: item.code,
                    url: item.url,
                    ...
                    cbitemDelete: _this2.cbitemDelete,
                    cbitemClicked: _this2.cbitemClicked
                });
            });
...
var ItemGoods = function (_React$Component) {
    _inherits(ItemGoods, _React$Component);

    function ItemGoods(props) {
        _classCallCheck(this, ItemGoods);

        var _this = _possibleConstructorReturn(this, (ItemGoods.__proto__ || Object.getPrototypeOf(ItemGoods)).call(this, props));

        _this.itemDelete = function (EO) {
            if (confirm("Удалить товар?")) _this.props.cbitemDelete(_this.props.code);
        };

        _this.itemClicked = function (EO) {
            _this.props.cbitemClicked(_this.props.code);
        };

        _this.render = function () {
            return _react2.default.createElement(
                'tr',
                { className: this.props.selected == this.props.code ? "selected" : null, onClick: this.itemClicked },
                _react2.default.createElement(
                    'td',
                    { className: '' },
                    this.props.name
...
module.exports = [{"name":"product1","code":1,"price":30,"url":"http://gffd.com","quantity":200},{"name":"product2","code":2,"price":20,"url":"http://gffff.com","quantity":100},{"name":"product3","code":3,"price":40,"url":"http://ddfd.com","quantity":180},{"name":"product4","code":4,"price":35,"url":"http://fdfc.com","quantity":170},{"name":"product5","code":5,"price":25,"url":"http://frwq.com","quantity":110},{"name":"product6","code":6,"price":28,"url":"http://kjhj.com","quantity":150},{"name":"product7","code":7,"price":45,"url":"http://ukjt.com","quantity":271},{"name":"product8","code":8,"price":27,"url":"http://hrhr.com","quantity":124},{"name":"product9","code":9,"price":11,"url":"http://gtre.com","quantity":312},{"name":"product10","code":10,"price":60,"url":"http://phyt.com","quantity":57}]
